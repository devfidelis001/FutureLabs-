...
class Futurelabs:
    def __init__(self, name, age, skill, phone_number, amount):
        self.names = name
        self.ages = age
        self.skills = skill
        self.number = phone_number
    ...
    def show(self):
        print(f"""student names: {self.names}
                student age: {self.ages}
                student skill: {self.skills}
                student phone number: {self.number}
                total of people available: {self.amount}
            """)
name = []
while True:       
    name.append(input("student name>>"))
    age = input("student age>>")
    skill = input("student skill>>")
    phone_number = input("student phone number>>")
    amount = len(name)

    student = Futurelabs(name, age, skill, phone_number, amount)
    student.show()
